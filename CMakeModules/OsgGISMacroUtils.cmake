...
# Takes optional second argument as test arguments
MACRO(SETUP_TEST_APPLICATION APPLICATION_NAME)
	SETUP_APPLICATION(${APPLICATION_NAME} 1)
        
#    INSTALL(TARGETS ${TARGET_TARGETNAME} RUNTIME DESTINATION bin  )
    ADD_TEST(${TARGET_TARGETNAME} ${EXECUTABLE_OUTPUT_PATH}/${TARGET_TARGETNAME} ${ARGV1} ${ARGV2} ${ARGV3} ${ARGV4})

ENDMACRO(SETUP_TEST_APPLICATION)
