...
//        if ( archive.valid() )
//        {
//            need_to_compile = true; // incremental not supported for archives.
//        }
//        else
//        {
//            need_to_compile = !osgDB::fileExists( abs_output_uri );
//            if ( !need_to_compile )
//            {
//                // read it so we can properly re-build the PagedLOD centroid/radius.
//                // In the future we will read in the original MASTER file as a reference
//                // along with a grid cell metadata record.
//                result_node = osgDB::readNodeFile( abs_output_uri );
//            }
//        }
//
//        if ( need_to_compile )
